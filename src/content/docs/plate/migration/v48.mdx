...
<Callout type="info">
  This page covers **major breaking changes** for Plate up to v48. For the latest
  migration guide, see [Latest Migration](/docs/migration). For patch and minor changes,
  refer to the individual package `CHANGELOG.md` files or visit the [GitHub
  Releases](https://github.com/udecode/plate/releases) page.
</Callout>
