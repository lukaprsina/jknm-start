...
<Callout type="info">
  This page only covers **major breaking changes**. For patch and minor changes, refer to
  the individual package `CHANGELOG.md` files or visit the [GitHub
      ...
      BlockPlaceholderPlugin.configure({
        options: {
          ...
          query: ({ editor, path }) => {
            ...
            return path.length === 1 && editor.api.isEmpty(editor.children[path[0]]);
          },
        },
      });
      ```
