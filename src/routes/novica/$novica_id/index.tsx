  ...
  const editor = createSlateEditor({
    ...
    value: (editor) => {
      ...
      if (!article.content_markdown) {
        console.warn("No content found for the article with ID:", novica_id_number);
        return [{ type: "paragraph", children: [{ text: "No content found" }] }];
      }

      return editor.getApi(MarkdownPlugin).markdown.deserialize(article.content_markdown);
    },
  });
