...
<API name="SuggestionPlugin">
  <APIOptions>
    <APIItem name="currentUserId" type="string | null">
      ID of the current user creating suggestions. Required for proper suggestion
      attribution.
    </APIItem>
...
<API name="dataList">
  ...
  <APIReturns type="TInlineSuggestionData[]">Array of suggestion data.</APIReturns>
</API>
...
<API name="nodeId">
  ...
  <APIReturns type="string | undefined">The suggestion ID if found.</APIReturns>
</API>
