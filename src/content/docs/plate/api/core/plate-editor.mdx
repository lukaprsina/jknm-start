  ...
  <APIAttributes>
    ...
    <APIItem name="dom" type="object">
      ...
      <APISubList>
        ...
        <APISubListItem
          parent="dom"
          name="currentKeyboardEvent"
          type="KeyboardEventLike | null"
        >
          The current keyboard event being processed by the editor, or null if no event is
          being processed.
        </APISubListItem>
    ...
    <APIItem name="meta" type="object">
      An object containing editor metadata, often derived from plugins or editor
      configuration.
      <APISubList>
        <APISubListItem
          parent="meta"
        ...
        <APISubListItem parent="meta" name="isFallback" type="boolean">
          Whether the editor is a fallback editor. - **Default:** `false`
        </APISubListItem>
...
<API name="API">
  <APIMethods>
    ...
    <APIItem
      name="getTransforms"
      type="(plugin: PlatePlugin) => EditorTransforms & PlatePlugin['transforms']"
    >
    ...
    <APIItem name="init" type="(options: InitOptions) => void">
      Initialize the editor value, selection, and normalization. Accepts options for
      auto-select, selection, normalization, value, and an `onReady` callback that
      provides context on initialization completion.
    </APIItem>
  </APIMethods>
</API>
...
<API name="Options">
  <APIMethods>
    ...
    <APIItem
      name="setOption"
      type="(plugin: PlatePlugin, optionKey: string, value: any) => void"
    >
      Set a specific option value for a plugin.
    </APIItem>
    <APIItem
      name="setOptions"
      type="(plugin: PlatePlugin, options: (draft: object) => void | Partial<object>) => void"
    >
...
<API name="HtmlPlugin">
  <APIListAPI>
    <APIItem
      ...
      type="(options: { element: HTMLElement }) => Descendant[]"
    >
...
<APITransforms>
  <APIItem name="editor.tf.setValue" type="(value: Value) => void">
    Replace the editor value. See [Controlled Value](/docs/controlled) for more
    information.
  </APIItem>
</APITransforms>
